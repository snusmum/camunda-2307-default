...
class WatermarkService {
    ...
    private fun textToLines(text: String, font: Font, metrics: FontMetrics, image: BufferedImage): MutableList<String> {
    ...
    private fun drawText(textLines: List<String>, font: Font, image: BufferedImage, graphics: Graphics) {
        val positionX = 0
